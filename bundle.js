...
var _ajaxCalls = __webpack_require__(56);

var getData = _interopRequireWildcard(_ajaxCalls);
...
var PageTitle = _styledComponents2.default.h1(_templateObject2);

var PageSubTitle = _styledComponents2.default.p(_templateObject3);

var AuthorLink = _styledComponents2.default.a(_templateObject4);
...
var Main = function (_React$Component) {
  ...
  function Main(props) {
    ...
    _this.state = { educationData: null, topographicData: null };
    return _this;
  }
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          PageSubTitle,
          null,
          'A map showing educational attainment by county ',
          _react2.default.createElement('br', null),
          ' created using D3 and React by ',
          _react2.default.createElement(
            AuthorLink,
            { href: 'www.github.com/aaronRhodebeck' },
            'Aaron Rhodebeck'
          )
        ),
        this.state.educationData && this.state.topographicData && _react2.default.createElement(_Chart2.default, {
...
var _reactFauxDom = __webpack_require__(40);
...
var window = __webpack_require__(52)
var withFauxDOM = __webpack_require__(53)
...
var React = __webpack_require__(1)
var styleAttr = __webpack_require__(43)
var querySelectorAll = __webpack_require__(44)
...
var mapValues = __webpack_require__(17)
var styleCamelCase = __webpack_require__(51)
...
exports.getEducationData = getEducationData;
exports.getTopographicalData = getTopographicalData;
function getEducationData(component) {
  var getData = new XMLHttpRequest();
  getData.open('GET', 'https://raw.githubusercontent.com/no-stack-dub-sack/testable-projects-fcc/master/src/data/choropleth_map/for_user_education.json', true);
  getData.send();
  getData.onload = function () {
    var educationData = JSON.parse(getData.responseText);
    component.setState({ educationData: educationData });
  };
}

function getTopographicalData(component) {
  var getData = new XMLHttpRequest();
  getData.open('GET', 'https://raw.githubusercontent.com/no-stack-dub-sack/testable-projects-fcc/master/src/data/choropleth_map/counties.json', true);
  getData.send();
  getData.onload = function () {
    var topographicData = JSON.parse(getData.responseText);
    component.setState({ topographicData: topographicData });
  };
}
